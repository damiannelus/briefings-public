...
SURFER_PROFILES = ["general", "professional", "ksiegowy", "professional_tech_leadership", "fintech", "KSA_venture_building", "AI-Developer_Manager"]
NUREK_PROFILES = ["general", "professional", "ksiegowy", "professional_tech_leadership", "fintech", "KSA_venture_building", "AI-Developer_Manager"]  # na razie pusta/dummy
